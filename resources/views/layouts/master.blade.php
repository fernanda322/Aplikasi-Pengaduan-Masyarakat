...
<head>
    ...
    <title>Pengaduan Masyarakt</title>
    <!-- Fevicon -->
            ...
            <div class="sidebar" >
                ...
                <div class="navigationbar">
                    ...
                    <ul class="vertical-menu myposition">
                        ...
                        <li>
                            <a href="javaScript:void();" class="myalink">
                              <img src="{{asset('assets/images/svg-icon/userinfo.svg')}}" class="img-fluid" alt="userinfo"><span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="javaScript:void();" class="myalink">
                                <img src="{{asset('assets/images/svg-icon/lockicon.svg')}}" class="img-fluid" alt="lockicon"><span>Deposit</span><i class="feather icon-chevron-right pull-right"></i>
                            </a>
                            <ul class="vertical-submenu">
                                <li><a href="basic-ui-kits-alerts.html">Reset Account Password</a></li>
                                <li><a href="basic-ui-kits-badges.html">Reset MT4 Password</a></li>
                                <li><a href="basic-ui-kits-buttons.html">Reset 6 Digit Pin</a></li>
                            </ul>
                        </li>
                        <li>
                            <a href="javaScript:void();" class="myalink">
                                <img src="{{asset('assets/images/svg-icon/logout.svg')}}" class="img-fluid" alt="lockout"><span>Logout</span>
                            </a>
                        </li>                                         
                    </ul>
                </div>
                                    ...
                                    <div class="profilebar">
                                        <div class="dropdown">
                                          <a class="dropdown-toggle" href="#" role="button" id="profilelink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            <img src="{{asset('assets/images/users/profile.svg')}}" class="img-fluid" alt="profile">Tun EL<span class="feather icon-chevron-down live-icon"></span>
                                                ...
                                                <div class="userbox">
                                                    <ul class="list-unstyled mb-0">
                                                        <li class="media dropdown-item">
                                                            <a href="#" class="profile-icon"><img src="{{asset('assets/images/svg-icon/userinfo.svg')}}" class="img-fluid" alt="user">My Profile</a>
                                                        </li>
                                                        <li class="media dropdown-item">
                                                            <a href="#" class="profile-icon"><img src="{{asset('assets/images/svg-icon/tables.svg')}}" class="img-fluid" alt="email">Email</a>
                                                        </li>                                                        
                                                        <li class="media dropdown-item">
