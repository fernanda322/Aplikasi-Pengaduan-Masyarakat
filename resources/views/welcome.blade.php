      ...
      @if(Session::get('sukses'))
                            ...
                            <form method="post"  action="{{ url('/postlapor') }}">
                              ...
                              <div class="form-group">
                                <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Nama Lengkap">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="input-group mb-3">
                                Lokasi
                              <textarea name="lokasi"style="width:1000px;"></textarea>
                          </div>
                          <div class="input-group mb-3">
                            Keterangan
                              <textarea name="ket" style="width:1000px;"></textarea>
                            </div>
